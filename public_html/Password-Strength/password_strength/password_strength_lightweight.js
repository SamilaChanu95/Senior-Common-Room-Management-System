...
(function ($, window, document, undefined) {
    ...
    const pluginName = 'strength_meter',
        defaults = {
    ...
    Plugin.prototype._create = function () {
        ...
        this.content.$toggleButton.bind("click", function (e) {
            ...
            const text = that.content.$passwordInput.is(":visible") ? that.options.showPasswordText : that.options.hidePasswordText;
        ...
        Plugin.prototype._bind_input_events = function ($s) {
            ...
            $s.bind('keyup', function () {
                ...
                const number = password.match(numbers) ? 1 : 0;
        ...
        Plugin.prototype._update_indicator = function (total) {
            const meter = this.content.$dataMeter;
        ...
        Plugin.prototype._update_info = function (criterion, isValid) {
            const $passwordCriteria = this.element.find('li[data-criterion="' + criterion + '"]');

<!-- Modal -->
<div class="modal fade" id="update_product_form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="form_update_product" onsubmit="return false" name="test">
                    ...
                    <div class="form-group">
                        ...
                        <label for="select_cat"></label><select class="form-control" id="select_cat" name="select_cat"
                                                                required>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Supplier</label>
                        <label for="select_brand"></label><select class="form-control" id="select_brand"
                                                                  name="select_brand" required>
                        </select>
                    </div>
                    <div class="form-group">

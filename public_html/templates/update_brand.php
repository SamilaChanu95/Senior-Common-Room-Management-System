<!-- Modal -->
<div class="modal fade" id="form_update_brand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="update_brand_form" onsubmit="return false">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="update_s_contactno" id="update_s_contactno"
                               placeholder="Edit Supplier Contact No"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="update_address" id="update_address"
                               placeholder="Edit Supplier Address"/>
